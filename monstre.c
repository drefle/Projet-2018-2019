  ...
  while(!hors_liste(l_monstre)){
    ...
    if(i % m->vitesse == 0){
      if( dist_monstre == 2){
        ...
        if( mat_distance[m->x_salle][m->y_salle+1] == dist_monstre-1 ){
          m->y_salle++;

        }else if( mat_distance[m->x_salle][m->y_salle-1] == dist_monstre-1 ){
          m->y_salle--;

        }else if( mat_distance[m->x_salle+1][m->y_salle] == dist_monstre-1 ){
          m->x_salle++;
        ...
        if( mat_distance[m->x_salle+1][m->y_salle] == dist_monstre-1 ){
          m->x_salle++;
    ...
    salle->m_salle[m->x_salle][m->y_salle] = 4;
    suivant(l_monstre);
